import CacheTaskQueue from "./CacheTaskQueue";
import CachedInfoQueue from "./CachedInfoQueue";
import DownloadFileUtil from "./DownloadFileUtil";
import CacheInfo from "./CacheInfo";

export default class CacheMgr<T> {
